...
$fontUrl = 'https://github.com/mozilla/Fira/archive/4.202.zip'
$checksumType = 'sha256';
$checksum = '2D2FB71B186DDD4CDBBCCCA98ED9BD6A8A94BD05865F94B39B71AF80EB3736A4';

$destination = Join-Path $Env:Temp 'Fira'

Install-ChocolateyZipPackage -PackageName 'Fira' -url $fontUrl -unzipLocation $destination -ChecksumType "$checksumType" -Checksum "$checksum"
